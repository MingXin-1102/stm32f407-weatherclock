 ...
 * @param x 起始x坐标
 * @param y 起始y坐标
 * @param font_lib 字库数组指针
 * @param index 字符在字库中的索引
 * @param size 字体大小（点阵尺寸，如12,16,24等）
 * @param font_data_size 单个字符数据大小（字节数）
 * @param color 字体颜色
 * @param bgcolor 背景颜色
 */
 ...
 * @param x 起始x坐标
 * @param y 起始y坐标
 * @param str_index 字符串索引数组
 * @param len 字符串长度（字符个数）
 * @param font_lib 字库数组指针
 * @param size 字体大小
 * @param font_data_size 单个字符数据大小
 * @param color 字体颜色
 * @param bgcolor 背景颜色
 */
...
/**
 * @brief 显示中文字符串（简化版本，自动计算常用字体数据大小）
 * @param x 起始x坐标
 * @param y 起始y坐标
 * @param str_index 字符串索引数组
 * @param len 字符串长度
